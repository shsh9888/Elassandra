...
def get_num_songs(h5):
    ...
    """
    return int(h5.root.metadata.songs.nrows)
...
def get_artist_familiarity(h5, songidx=0):
    ...
    """
    return float(h5.root.metadata.songs.cols.artist_familiarity[songidx])
...
def get_artist_hotttnesss(h5, songidx=0):
    ...
    """
    return float(h5.root.metadata.songs.cols.artist_hotttnesss[songidx])
...
def get_artist_playmeid(h5, songidx=0):
    ...
    """
    return int(h5.root.metadata.songs.cols.artist_playmeid[songidx])
...
def get_artist_7digitalid(h5, songidx=0):
    ...
    """
    return int(h5.root.metadata.songs.cols.artist_7digitalid[songidx])
...
def get_artist_latitude(h5, songidx=0):
    ...
    """
    return float(h5.root.metadata.songs.cols.artist_latitude[songidx])
...
def get_artist_longitude(h5, songidx=0):
    ...
    """
    return float(h5.root.metadata.songs.cols.artist_longitude[songidx])
...
def get_release_7digitalid(h5, songidx=0):
    ...
    """
    return int(h5.root.metadata.songs.cols.release_7digitalid[songidx])
...
def get_song_hotttnesss(h5, songidx=0):
    ...
    """
    return float(h5.root.metadata.songs.cols.song_hotttnesss[songidx])
...
def get_track_7digitalid(h5, songidx=0):
    ...
    """
    return int(h5.root.metadata.songs.cols.track_7digitalid[songidx])
...
def get_analysis_sample_rate(h5, songidx=0):
    ...
    """
    return int(h5.root.analysis.songs.cols.analysis_sample_rate[songidx])
...
def get_danceability(h5, songidx=0):
    ...
    """
    return float(h5.root.analysis.songs.cols.danceability[songidx])
...
def get_duration(h5, songidx=0):
    ...
    """
    return float(h5.root.analysis.songs.cols.duration[songidx])
...
def get_end_of_fade_in(h5, songidx=0):
    ...
    """
    return float(h5.root.analysis.songs.cols.end_of_fade_in[songidx])
...
def get_energy(h5, songidx=0):
    ...
    """
    return float(h5.root.analysis.songs.cols.energy[songidx])
...
def get_key(h5, songidx=0):
    ...
    """
    return int(h5.root.analysis.songs.cols.key[songidx])
...
def get_key_confidence(h5, songidx=0):
    ...
    """
    return float(h5.root.analysis.songs.cols.key_confidence[songidx])
...
def get_loudness(h5, songidx=0):
    ...
    """
    return float(h5.root.analysis.songs.cols.loudness[songidx])
...
def get_mode(h5, songidx=0):
    ...
    """
    return int(h5.root.analysis.songs.cols.mode[songidx])
...
def get_mode_confidence(h5, songidx=0):
    ...
    """
    return float(h5.root.analysis.songs.cols.mode_confidence[songidx])
...
def get_start_of_fade_out(h5, songidx=0):
    ...
    """
    return float(h5.root.analysis.songs.cols.start_of_fade_out[songidx])
...
def get_tempo(h5, songidx=0):
    ...
    """
    return float(h5.root.analysis.songs.cols.tempo[songidx])
...
def get_time_signature(h5, songidx=0):
    ...
    """
    return int(h5.root.analysis.songs.cols.time_signature[songidx])
...
def get_time_signature_confidence(h5, songidx=0):
    ...
    """
    return float(h5.root.analysis.songs.cols.time_signature_confidence[songidx])
...
def get_year(h5, songidx=0):
    ...
    """
    return int(h5.root.musicbrainz.songs.cols.year[songidx])
